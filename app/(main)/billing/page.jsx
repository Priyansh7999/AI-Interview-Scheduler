      ...
      <div className="max-w-6xl mx-auto">
            ...
            <CardContent className="pt-6">
              <div className="text-center">
                <div className="flex items-center justify-center gap-2 mb-2">
                  ...
                  <span className="text-xl">Current Credits</span>
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          {CREDIT_PACKAGES.map((pkg) => (
            <Card 
              key={pkg.id}
              className={`bg-card relative cursor-pointer transition-all hover:shadow-lg ${
        ...
        <Card className="max-w-md mx-auto">
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center p-3 rounded-lg border border-blue-200">
