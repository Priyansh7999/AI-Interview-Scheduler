...
const InterviewCompleted = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br flex items-center justify-center px-4 py-12">
      <div className="max-w-lg w-full bg-card p-8 rounded-3xl shadow-xl text-center border border-gray-100 overflow-hidden relative">
        {/* Decorative elements */}
        ...
        <div className="relative z-10 mx-auto flex items-center justify-center h-24 w-24 rounded-full bg-gradient-to-br from-green-100 to-green-50 mb-8 animate-pulse">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-3 relative z-10">
          Interview Submitted <span className="text-primary">Successfully</span>
        </h1>
        
        <p className="text-lg text-muted-foreground mb-8 relative z-10">
          Thank you for completing your interview with{' '}
          <span className="font-semibold text-blue-600 bg-blue-50 px-2 rounded-md">
            Recruiter AI
          </span> . 
        ...
        <div className="relative z-10 space-y-6 mb-8">
          <div className="flex items-start bg-gradient-to-r from-blue-200 to-yellow-200 p-4 rounded-xl border border-blue-100">
          ...
          <div className="flex items-start bg-gradient-to-r from-purple-50 to-orange-200 p-4 rounded-xl border border-purple-100">
            ...
            <div className="text-left">
              ...
              <p className="text-gray-600 text-sm mt-1">
                ...
                <span className="font-medium  px-1 py-0.5 rounded text-purple-700">
                  3 business days
                </span>.
              </p>
            </div>
          ...
          <div className="flex items-start bg-gradient-to-r from-green-50 to-indigo-200 p-4 rounded-xl border border-green-100">
        ...
        {/* Final instructions */}
        <div className="relative z-10 bg-card rounded-xl p-5 border border-gray-200 shadow-inner">
          ...
          <p className="text-sm text-gray-500 mt-2">
            ...
            <span className="text-chart-1 font-medium">support@gmail.com</span>
          </p>
        </div>
      </div>
    </div>
